...
1. We add a new row and new column. Recall that the determinant can be defined recursively. Since the new matrix as a $1$ in the $\Sigma_{11}$ position, then the determinant remains the same.
